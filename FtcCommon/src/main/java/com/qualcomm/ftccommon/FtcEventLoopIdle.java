...
public class FtcEventLoopIdle extends FtcEventLoopBase
    ...
    public FtcEventLoopIdle(HardwareFactory hardwareFactory, OpModeRegister userOpmodeRegister, UpdateUI.Callback callback, Activity activityContext) //modified for lite: remmove programming mode controller parameter
    {
    ...
    @Override public void loop() throws RobotCoreException, InterruptedException
        {
        try {
            //checkForChangedOpModes(); modified for lite
            }
        catch (Exception e)
            {
